                  ...
                  <tbody>
                    {districtRisks.map((risk, idx) => (
                      <tr key={risk.id} style={{ borderBottom: '1px solid var(--border)' }}>
                        <td style={{ padding: '10px 16px', fontSize: '12px', color: 'var(--text-muted)', wordBreak: 'break-word' }}>{idx + 1}</td>
                        <td style={{ padding: '10px 16px', fontSize: '12px', fontWeight: 'bold', color: 'var(--text-primary)', wordBreak: 'break-word' }}>{risk.district}</td>
                        <td style={{ padding: '10px 16px', fontSize: '12px', color: getTierColor(risk.tier), fontWeight: 'bold', wordBreak: 'break-word' }}>{risk.score}</td>
                        <td style={{ padding: '10px 16px', fontSize: '12px', wordBreak: 'break-word' }}>
                  ...
                  <tbody>
                    {roadStatus.map((road) => (
                      <tr key={road.id} style={{ borderBottom: '1px solid var(--border)' }}>
                        <td style={{ padding: '10px 16px', fontSize: '12px', fontWeight: 'bold', color: 'var(--text-primary)', wordBreak: 'break-word' }}>{road.name}</td>
                        <td style={{ padding: '10px 16px', fontSize: '12px', color: 'var(--text-secondary)', wordBreak: 'break-word' }}>{road.district}</td>
                        <td style={{ padding: '10px 16px', fontSize: '12px', wordBreak: 'break-word' }}>
                        ...
                        <td style={{ padding: '10px 16px', fontSize: '12px', color: 'var(--text-secondary)', wordBreak: 'break-word' }}>{road.hours ? `${road.hours}h` : '—'}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
