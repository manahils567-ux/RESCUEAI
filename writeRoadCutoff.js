...
// Map rivers to the districts they flow through
...
async function updateAllRoadStatuses() {
  ...
  for (const road of roads) {
    ...
    // proximity: roads closer to river flood faster
...
fs.writeFileSync('./services/roadCutoff.js', code);
console.log('Done — roadCutoff.js written');